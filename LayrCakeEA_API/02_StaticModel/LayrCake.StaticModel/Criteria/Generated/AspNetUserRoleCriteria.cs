...
{
	// Render the class
	public partial class AspNetUserRoleVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int AspNetUserRoleID { get; set; }

		private Specification<AspNetUserRoleVwm> _specification;
		public Specification<AspNetUserRoleVwm> Specification
		{
