...
{
	// Render the class
	public partial class AspNetUserLoginVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int AspNetUserLoginID { get; set; }

		private Specification<AspNetUserLoginVwm> _specification;
		public Specification<AspNetUserLoginVwm> Specification
		{
