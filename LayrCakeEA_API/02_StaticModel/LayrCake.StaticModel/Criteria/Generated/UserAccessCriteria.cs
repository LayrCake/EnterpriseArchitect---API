...
{
	// Render the class
	public partial class UserAccessVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int UserAccessID { get; set; }

		private Specification<UserAccessVwm> _specification;
		public Specification<UserAccessVwm> Specification
		{
