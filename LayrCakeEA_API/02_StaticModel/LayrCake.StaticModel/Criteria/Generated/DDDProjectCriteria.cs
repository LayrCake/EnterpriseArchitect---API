...
{
	// Render the class
	public partial class DDDProjectVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int DDDProjectID { get; set; }

		private Specification<DDDProjectVwm> _specification;
		public Specification<DDDProjectVwm> Specification
		{
