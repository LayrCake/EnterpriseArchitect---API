...
{
	// Render the class
	public partial class DDDPackageVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int DDDPackageID { get; set; }

		private Specification<DDDPackageVwm> _specification;
		public Specification<DDDPackageVwm> Specification
		{
		...
		public bool IncludeDDDElementsRecords { get; set; }
	}
}
