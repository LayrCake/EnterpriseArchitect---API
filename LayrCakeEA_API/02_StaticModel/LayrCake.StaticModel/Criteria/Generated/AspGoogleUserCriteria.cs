...
{
	// Render the class
	public partial class AspGoogleUserVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int AspGoogleUserID { get; set; }

		private Specification<AspGoogleUserVwm> _specification;
		public Specification<AspGoogleUserVwm> Specification
		{
