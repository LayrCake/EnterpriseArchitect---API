...
{
	// Render the class
	public partial class DDDAttributeVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int DDDAttributeID { get; set; }

		private Specification<DDDAttributeVwm> _specification;
		public Specification<DDDAttributeVwm> Specification
		{
