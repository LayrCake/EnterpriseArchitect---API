...
{
	// Render the class
	public partial class TrafficDetailVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int TrafficDetailID { get; set; }

		private Specification<TrafficDetailVwm> _specification;
		public Specification<TrafficDetailVwm> Specification
		{
