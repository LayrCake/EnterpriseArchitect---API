...
{
	// Render the class
	public partial class DDDLayerVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int DDDLayerID { get; set; }

		private Specification<DDDLayerVwm> _specification;
		public Specification<DDDLayerVwm> Specification
		{
