...
{
	// Render the class
	public partial class DDDConnectorVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int DDDConnectorID { get; set; }

		private Specification<DDDConnectorVwm> _specification;
		public Specification<DDDConnectorVwm> Specification
		{
