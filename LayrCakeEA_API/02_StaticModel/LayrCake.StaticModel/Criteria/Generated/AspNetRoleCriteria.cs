...
{
	// Render the class
	public partial class AspNetRoleVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int AspNetRoleID { get; set; }

		private Specification<AspNetRoleVwm> _specification;
		public Specification<AspNetRoleVwm> Specification
		{
