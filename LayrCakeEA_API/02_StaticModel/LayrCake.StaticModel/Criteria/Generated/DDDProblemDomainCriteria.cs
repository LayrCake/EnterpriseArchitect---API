...
{
	// Render the class
	public partial class DDDProblemDomainVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int DDDProblemDomainID { get; set; }

		private Specification<DDDProblemDomainVwm> _specification;
		public Specification<DDDProblemDomainVwm> Specification
		{
		...
		public bool IncludeDDDSolutionsRecords { get; set; }
	}
}
