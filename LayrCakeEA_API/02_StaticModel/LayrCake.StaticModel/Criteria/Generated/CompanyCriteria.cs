...
{
	// Render the class
	public partial class CompanyVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int CompanyID { get; set; }

		private Specification<CompanyVwm> _specification;
		public Specification<CompanyVwm> Specification
		{
