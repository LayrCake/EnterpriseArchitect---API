...
{
	// Render the class
	public partial class UserSessionHistoryVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int UserSessionHistoryID { get; set; }

		private Specification<UserSessionHistoryVwm> _specification;
		public Specification<UserSessionHistoryVwm> Specification
		{
