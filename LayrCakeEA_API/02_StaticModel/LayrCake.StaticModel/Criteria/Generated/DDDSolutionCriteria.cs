...
{
	// Render the class
	public partial class DDDSolutionVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int DDDSolutionID { get; set; }

		private Specification<DDDSolutionVwm> _specification;
		public Specification<DDDSolutionVwm> Specification
		{
		...
		public bool IncludeDDDLayersRecords { get; set; }
		public bool IncludeDDDPackagesRecords { get; set; }
		public bool IncludeDDDProjectsRecords { get; set; }
	}
}
