...
{
	// Render the class
	public partial class ConfigVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int ConfigID { get; set; }

		private Specification<ConfigVwm> _specification;
		public Specification<ConfigVwm> Specification
		{
