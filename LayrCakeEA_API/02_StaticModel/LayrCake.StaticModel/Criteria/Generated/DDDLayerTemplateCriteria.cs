...
{
	// Render the class
	public partial class DDDLayerTemplateVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int DDDLayerTemplateID { get; set; }

		private Specification<DDDLayerTemplateVwm> _specification;
		public Specification<DDDLayerTemplateVwm> Specification
		{
