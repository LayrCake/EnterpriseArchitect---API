...
{
	// Render the class
	public partial class DDDElementVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int DDDElementID { get; set; }

		private Specification<DDDElementVwm> _specification;
		public Specification<DDDElementVwm> Specification
		{
		...
		public bool IncludeDDDMethodsRecords { get; set; }
		public bool IncludeDDDPropertiesRecords { get; set; }
	}
}
