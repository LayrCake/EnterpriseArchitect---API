...
{
	// Render the class
	public partial class AspNetUserClaimVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int AspNetUserClaimID { get; set; }

		private Specification<AspNetUserClaimVwm> _specification;
		public Specification<AspNetUserClaimVwm> Specification
		{
