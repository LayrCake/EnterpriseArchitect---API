...
{
	// Render the class
	public partial class DDDPropertyVwmCriteria : VwmCriteria, IVwmCriteria
	{
		public int DDDPropertyID { get; set; }

		private Specification<DDDPropertyVwm> _specification;
		public Specification<DDDPropertyVwm> Specification
		{
