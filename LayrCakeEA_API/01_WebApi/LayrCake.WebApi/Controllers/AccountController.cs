...
namespace LayrCake.WebApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        private LayrCakeUserManager _userManager;
        ...
        public AccountController(LayrCakeUserManager userManager,
        ...
        public LayrCakeUserManager UserManager
        {
            get
            {
                return _userManager ?? HttpContext.Current.GetOwinContext().GetUserManager<LayrCakeUserManager>();
            }
            private set
            {
                _userManager = value;
        ...
        //{
        //    Authentication.SignIn(CookieAuthenticationDefaults.AuthenticationType);
        //    return Ok();
        //}
        ...
        {
            AspNetUserExtVwm user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
            ...
            foreach (AspNetUserLoginVwm linkedAccount in user.AspNetUserLogins)
            {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel register)
        {
            ...
            try
            {
                var user = new AspNetUserExtVwm() { UserName = register.Email, Email = register.Email };
        ...
        public async Task<IHttpActionResult> RegisterExternal(RegisterExternalBindingModel model)
        {
            ...
            var user = new AspNetUserExtVwm() { UserName = model.Email, Email = model.Email };
