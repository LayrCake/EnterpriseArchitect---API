...
{
    public partial class Api_DDDLayerTemplate_Tests : BaseTestInitialise
    {
		public async Task<List<DDDLayerTemplate>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/dddlayertemplate");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<DDDLayerTemplate>>(stream);
		...
		public async Task Insert(DDDLayerTemplate insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/dddlayertemplate", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            DDDLayerTemplate resultPost = postResponse.Content.ReadAsAsync<DDDLayerTemplate>().Result;
            ...
            DDDLayerTemplate resultRead = queryResponse.Content.ReadAsAsync<DDDLayerTemplate>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
