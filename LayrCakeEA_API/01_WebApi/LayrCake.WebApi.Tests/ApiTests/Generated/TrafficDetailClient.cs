...
{
    public partial class Api_TrafficDetail_Tests : BaseTestInitialise
    {
		public async Task<List<TrafficDetail>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/trafficdetail");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<TrafficDetail>>(stream);
		...
		public async Task Insert(TrafficDetail insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/trafficdetail", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            TrafficDetail resultPost = postResponse.Content.ReadAsAsync<TrafficDetail>().Result;
            ...
            TrafficDetail resultRead = queryResponse.Content.ReadAsAsync<TrafficDetail>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
