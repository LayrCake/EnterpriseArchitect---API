...
{
    public partial class Api_DDDElement_Tests : BaseTestInitialise
    {
		public async Task<List<DDDElement>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/dddelement");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<DDDElement>>(stream);
		...
		public async Task Insert(DDDElement insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/dddelement", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            DDDElement resultPost = postResponse.Content.ReadAsAsync<DDDElement>().Result;
            ...
            DDDElement resultRead = queryResponse.Content.ReadAsAsync<DDDElement>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
