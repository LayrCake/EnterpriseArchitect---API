...
{
    public partial class Api_UserSessionHistory_Tests : BaseTestInitialise
    {
		public async Task<List<UserSessionHistory>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/usersessionhistory");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<UserSessionHistory>>(stream);
		...
		public async Task Insert(UserSessionHistory insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/usersessionhistory", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            UserSessionHistory resultPost = postResponse.Content.ReadAsAsync<UserSessionHistory>().Result;
            ...
            UserSessionHistory resultRead = queryResponse.Content.ReadAsAsync<UserSessionHistory>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
