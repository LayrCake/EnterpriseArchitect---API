...
{
    public partial class Api_DDDProject_Tests : BaseTestInitialise
    {
		public async Task<List<DDDProject>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/dddproject");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<DDDProject>>(stream);
		...
		public async Task Insert(DDDProject insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/dddproject", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            DDDProject resultPost = postResponse.Content.ReadAsAsync<DDDProject>().Result;
            ...
            DDDProject resultRead = queryResponse.Content.ReadAsAsync<DDDProject>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
