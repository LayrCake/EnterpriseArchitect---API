...
{
    public partial class Api_UserRegistration_Tests : BaseTestInitialise
    {
		public async Task<List<UserRegistration>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/userregistration");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<UserRegistration>>(stream);
		...
		public async Task Insert(UserRegistration insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/userregistration", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            UserRegistration resultPost = postResponse.Content.ReadAsAsync<UserRegistration>().Result;
            ...
            UserRegistration resultRead = queryResponse.Content.ReadAsAsync<UserRegistration>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
