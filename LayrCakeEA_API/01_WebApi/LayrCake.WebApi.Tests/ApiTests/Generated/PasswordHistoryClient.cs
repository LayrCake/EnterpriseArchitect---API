...
{
    public partial class Api_PasswordHistory_Tests : BaseTestInitialise
    {
		public async Task<List<PasswordHistory>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/passwordhistory");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<PasswordHistory>>(stream);
		...
		public async Task Insert(PasswordHistory insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/passwordhistory", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            PasswordHistory resultPost = postResponse.Content.ReadAsAsync<PasswordHistory>().Result;
            ...
            PasswordHistory resultRead = queryResponse.Content.ReadAsAsync<PasswordHistory>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
