...
{
    public partial class Api_DDDAttribute_Tests : BaseTestInitialise
    {
		public async Task<List<DDDAttribute>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/dddattribute");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<DDDAttribute>>(stream);
		...
		public async Task Insert(DDDAttribute insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/dddattribute", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            DDDAttribute resultPost = postResponse.Content.ReadAsAsync<DDDAttribute>().Result;
            ...
            DDDAttribute resultRead = queryResponse.Content.ReadAsAsync<DDDAttribute>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
