...
{
    public partial class Api_Company_Tests : BaseTestInitialise
    {
		public async Task<List<Company>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/company");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<Company>>(stream);
		...
		public async Task Insert(Company insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/company", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            Company resultPost = postResponse.Content.ReadAsAsync<Company>().Result;
            ...
            Company resultRead = queryResponse.Content.ReadAsAsync<Company>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
