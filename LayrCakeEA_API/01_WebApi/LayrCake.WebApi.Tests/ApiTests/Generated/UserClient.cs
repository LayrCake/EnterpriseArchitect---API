...
{
    public partial class Api_User_Tests : BaseTestInitialise
    {
		public async Task<List<User>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/user");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<User>>(stream);
		...
		public async Task Insert(User insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/user", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            User resultPost = postResponse.Content.ReadAsAsync<User>().Result;
            ...
            User resultRead = queryResponse.Content.ReadAsAsync<User>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
