...
{
    public partial class Api_DDDConnector_Tests : BaseTestInitialise
    {
		public async Task<List<DDDConnector>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/dddconnector");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<DDDConnector>>(stream);
		...
		public async Task Insert(DDDConnector insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/dddconnector", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            DDDConnector resultPost = postResponse.Content.ReadAsAsync<DDDConnector>().Result;
            ...
            DDDConnector resultRead = queryResponse.Content.ReadAsAsync<DDDConnector>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
