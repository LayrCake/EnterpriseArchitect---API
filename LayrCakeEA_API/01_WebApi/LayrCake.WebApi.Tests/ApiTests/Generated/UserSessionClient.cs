...
{
    public partial class Api_UserSession_Tests : BaseTestInitialise
    {
		public async Task<List<UserSession>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/usersession");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<UserSession>>(stream);
		...
		public async Task Insert(UserSession insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/usersession", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            UserSession resultPost = postResponse.Content.ReadAsAsync<UserSession>().Result;
            ...
            UserSession resultRead = queryResponse.Content.ReadAsAsync<UserSession>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
