...
{
    public partial class Api_FileUpload_Tests : BaseTestInitialise
    {
		public async Task<List<FileUpload>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/fileupload");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<FileUpload>>(stream);
		...
		public async Task Insert(FileUpload insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/fileupload", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            FileUpload resultPost = postResponse.Content.ReadAsAsync<FileUpload>().Result;
            ...
            FileUpload resultRead = queryResponse.Content.ReadAsAsync<FileUpload>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
