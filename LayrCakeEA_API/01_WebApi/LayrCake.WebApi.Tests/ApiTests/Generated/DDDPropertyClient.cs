...
{
    public partial class Api_DDDProperty_Tests : BaseTestInitialise
    {
		public async Task<List<DDDProperty>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/dddproperty");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<DDDProperty>>(stream);
		...
		public async Task Insert(DDDProperty insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/dddproperty", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            DDDProperty resultPost = postResponse.Content.ReadAsAsync<DDDProperty>().Result;
            ...
            DDDProperty resultRead = queryResponse.Content.ReadAsAsync<DDDProperty>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
