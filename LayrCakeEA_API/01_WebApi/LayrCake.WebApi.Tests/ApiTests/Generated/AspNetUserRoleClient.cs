...
{
    public partial class Api_AspNetUserRole_Tests : BaseTestInitialise
    {
		public async Task<List<AspNetUserRole>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/aspnetuserrole");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<AspNetUserRole>>(stream);
		...
		public async Task Insert(AspNetUserRole insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/aspnetuserrole", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            AspNetUserRole resultPost = postResponse.Content.ReadAsAsync<AspNetUserRole>().Result;
            ...
            AspNetUserRole resultRead = queryResponse.Content.ReadAsAsync<AspNetUserRole>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
