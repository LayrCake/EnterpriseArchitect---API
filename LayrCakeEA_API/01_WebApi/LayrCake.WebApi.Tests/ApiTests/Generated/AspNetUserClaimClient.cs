...
{
    public partial class Api_AspNetUserClaim_Tests : BaseTestInitialise
    {
		public async Task<List<AspNetUserClaim>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/aspnetuserclaim");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<AspNetUserClaim>>(stream);
		...
		public async Task Insert(AspNetUserClaim insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/aspnetuserclaim", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            AspNetUserClaim resultPost = postResponse.Content.ReadAsAsync<AspNetUserClaim>().Result;
            ...
            AspNetUserClaim resultRead = queryResponse.Content.ReadAsAsync<AspNetUserClaim>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
