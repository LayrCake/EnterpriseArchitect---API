...
{
    public partial class Api_AspGoogleUser_Tests : BaseTestInitialise
    {
		public async Task<List<AspGoogleUser>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/aspgoogleuser");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<AspGoogleUser>>(stream);
		...
		public async Task Insert(AspGoogleUser insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/aspgoogleuser", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            AspGoogleUser resultPost = postResponse.Content.ReadAsAsync<AspGoogleUser>().Result;
            ...
            AspGoogleUser resultRead = queryResponse.Content.ReadAsAsync<AspGoogleUser>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
