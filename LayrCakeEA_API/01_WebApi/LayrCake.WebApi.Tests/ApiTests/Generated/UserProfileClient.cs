...
{
    public partial class Api_UserProfile_Tests : BaseTestInitialise
    {
		public async Task<List<UserProfile>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/userprofile");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<UserProfile>>(stream);
		...
		public async Task Insert(UserProfile insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/userprofile", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            UserProfile resultPost = postResponse.Content.ReadAsAsync<UserProfile>().Result;
            ...
            UserProfile resultRead = queryResponse.Content.ReadAsAsync<UserProfile>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
