...
{
    public partial class Api_AspNetUser_Tests : BaseTestInitialise
    {
		public async Task<List<AspNetUser>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/aspnetuser");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<AspNetUser>>(stream);
		...
		public async Task Insert(AspNetUser insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/aspnetuser", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            AspNetUser resultPost = postResponse.Content.ReadAsAsync<AspNetUser>().Result;
            ...
            AspNetUser resultRead = queryResponse.Content.ReadAsAsync<AspNetUser>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
