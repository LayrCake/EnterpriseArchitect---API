...
{
    public partial class Api_AspNetUserLogin_Tests : BaseTestInitialise
    {
		public async Task<List<AspNetUserLogin>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/aspnetuserlogin");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<AspNetUserLogin>>(stream);
		...
		public async Task Insert(AspNetUserLogin insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/aspnetuserlogin", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            AspNetUserLogin resultPost = postResponse.Content.ReadAsAsync<AspNetUserLogin>().Result;
            ...
            AspNetUserLogin resultRead = queryResponse.Content.ReadAsAsync<AspNetUserLogin>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
