...
{
    public partial class Api_AspNetRole_Tests : BaseTestInitialise
    {
		public async Task<List<AspNetRole>> GetAll(HttpClient client = null)
		{
	        var request = client.GetAsync("tables/aspnetrole");
            ...
            var returnItems = JsonConvert.DeserializeObject<List<AspNetRole>>(stream);
		...
		public async Task Insert(AspNetRole insertItem, HttpClient client = null)
        {
            client = client ?? testClient;
			Uri location;

            // Post a new entity and verify entity returned
            HttpResponseMessage postResponse = client.PostAsJsonAsync("tables/aspnetrole", insertItem).Result;
            Assert.AreEqual(HttpStatusCode.Created, postResponse.StatusCode);
            location = postResponse.Headers.Location;
            Assert.IsNotNull(location);

            AspNetRole resultPost = postResponse.Content.ReadAsAsync<AspNetRole>().Result;
            ...
            AspNetRole resultRead = queryResponse.Content.ReadAsAsync<AspNetRole>().Result;
            //this.VerifySimpleEntitiesEqual(entity, result);
